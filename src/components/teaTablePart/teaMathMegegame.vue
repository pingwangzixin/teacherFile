<template>
  <div>
    <div class="jz_tong">
      <h3>
        <span v-show="!flag">参加数学大赛情况</span>
        <span v-show="flag">新增参加数学大赛情况</span>
...
export default {
  data() {
    return {
     ...
     tableData:[
          {
              head:['名称','级别','组织单位','获奖情况','时间'],
              data:[
                  {
                shuju:{name:'全国信息技术创新第三届大赛比拼',level:'国家级',unit:'中国教育学会',win:'二等奖',time:'2018年05月01日',pass:'未通过'},
                  },
              ]
        },
      ],
