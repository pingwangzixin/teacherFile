<template>
  <div>
    <div class="jz_tong">
      <h3>
        <span v-show="!flag">骨干教师学术讲座</span>
        <span v-show="flag">新增骨干教师学术讲座</span>
      ...
      <div class="jz_tab">
        <table v-show="!flag" v-for="(item,index) in tableData" :key="index">
          ...
          <tbody v-for="(m,n) in item.data" :key="n">
            <tr>
                <td v-for="(val,key,i2) in m.shuju" :key="i2"
              ...
              <td colspan="8">
                <div class="jz_editkh jz_bg">
                 ...
                 <p>
                  ...
                  <p>
                    <span>
                      <label for="unit">组织单位</label>
                    </span>
                    <input class="jz_inp" type="text" id="unit" placeholder="请输入名称" />
                  </p>
                  <p>
                    <span>
                      <label for="peo">听课人数</label>
                    </span>
                    <input type="text" id="peo" placeholder="请输入名称" />
                  </p>
                  <p>
                    <span>
                      <label for="zks">总课时</label>
                    </span>
                    <input  type="text" id="zks" placeholder="请输入名称" />
                  </p>
                  <p class="jz_p">
                    <span>荣誉证书</span>
                    <span class="jz_sp">
        ...
        <div class="jz_editkh" v-show="flag">
          <p>
            <span>
              <label for="mc2">名称</label>
            </span>
            <input class="jz_inp" type="text" id="mc2" placeholder="请输入名称" />
          </p>
           <p>
                    <span> 获奖时间</span>
                   <input type="date">
          ...
          <p class="jz_p">
            ...
            <p>
            <span>
              <label for="unit2">组织单位</label>
            </span>
            <input class="jz_inp" type="text" id="unit2" placeholder="请输入名称" />
          </p>
          <p>
            <span>
              <label for="tk2">听课人数</label>
            </span>
            <input  type="text" id="tk2" placeholder="请输入名称" />
          </p>
          <p>
            <span>
              <label for="zks2">总课时</label>
            </span>
            <input  type="text" id="zks2" placeholder="请输入名称" />
          </p>
...
export default {
  data() {
    return {
     ...
     tableData:[
          {
              head:['名称','级别','听课人数','总课时','组织单位','时间'],
              data:[
                  {
                shuju:{name:'全国信息技术创新第三届大赛比拼',level:'国家级',
                num:'65',alltime:'4',unit:'北京市东城区',time:'2018年05月01日',pass:'未通过'},
                  },
              ]
        },
      ],
