<template>
  <div>
    <div class="jz_tong">
      <h3>
        <span v-show="!flag">被指导学生情况</span>
        <span v-show="flag">新增被指导学生情况</span>
      ...
      <div class="jz_tab">
        <table v-show="!flag">
          <thead>
            <tr>
              <th width="90">被指导学生</th>
              <th width="46">级别</th>
              <th width="156">奖项名称</th>
              <th>表彰单位</th>
              <th width="130">时间</th>
              <th class="jz_shou" @click="state=!state" min-width="60">
                <i class="jz_xia"></i>
                状态
            ...
            <tr v-if="editIndex==index">
              <td colspan="7">
                <div class="jz_editkh jz_bg">
                  <p>
                    <span>
                      <label for="bezd0">被指导学生</label>
                    </span>
                    <input class="jz_inp" type="text" id="bezd0" placeholder="请输入名称" />
                  </p>
                  <p>
                    <span>时间</span>
                    <input type="date" />
                  ...
                  <p>
                    <span>
                      <label for="jname0">奖项名称</label>
                    </span>
                    <input class="jz_inp" type="text" id="jname0" placeholder="请输入名称" />
                  </p>
                  <p>
                    <span>
                      <label for="barea0">表彰单位</label>
                    </span>
                    <input class="jz_inp" type="text" id="barea0" placeholder="请输入名称" />
                  </p>
                  <p class="jz_p">
                    <span>荣誉证书</span>
                    <span class="jz_sp">
                      <label v-for="(item,index) in honorBook" :key="index" :for="'e11'+index">
                        <input
                          class="jz_radio"
                          type="radio"
                          name="ryzs2"
        ...
        <div class="jz_editkh" v-show="flag">
          <p>
            <span>
              <label for="bezd">被指导学生</label>
            </span>
            <input class="jz_inp" type="text" id="bezd" placeholder="请输入名称" />
          </p>
          <p>
            <span>时间</span>
            <input type="date" />
          ...
          <p>
            <span>
              <label for="jname">奖项名称</label>
            </span>
            <input class="jz_inp" type="text" id="jname" placeholder="请输入名称" />
          </p>
          <p>
            <span>
              <label for="barea">表彰单位</label>
            </span>
            <input class="jz_inp" type="text" id="barea" placeholder="请输入名称" />
          </p>
          <p class="jz_p">
            <span>荣誉证书</span>
            <span class="jz_sp">
              <label v-for="(item,index) in honorBook" :key="index" :for="'e1'+index">
                <input
                  class="jz_radio"
                  type="radio"
                  name="ryzs4"
                ...
                <label for="xzfile" v-show="index==1&&honRadio=='上传文件'">
                  <span class="jz_xzwj">选择文件</span>
                  <input type="file" id="xzfile" hidden accept="image/jpg, image/png,image/jpeg,application/pdf" />
                </label>
              </label>
              <span class="jz_an" v-show="handOrAuto">
                <input type="text" class="jz_inp" placeholder="请输入编号" />
