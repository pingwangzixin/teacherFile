<template>
  <div>
    <div class="jz_tong">
      <h3>
        <span v-show="!flag">组织公派支教经历</span>
        <span v-show="flag">新增组织公派支教经历</span>
      ...
      <div class="jz_tab">
            ...
            <tr v-if="editIndex==index">
              <td colspan="5">
                <div class="jz_editkh jz_bg">
                  ...
                  <p>
                    <span>
                      <label for="area2">支教地区</label>
                    </span>
                    <input type="text" class="jz_inp" id="area2" placeholder="请输入名称" />
                  </p>

                  <p>
                    <span>
                      <label for="school2">支教学校</label>
                    </span>
                    <input class="jz_inp" type="text" id="school2" placeholder="请输入名称" />
                  </p>
        ...
        <div class="jz_editkh" v-show="flag">
          ...
          <p>
            <span>
              <label for="area">支教地区</label>
            </span>
            <input type="text" class="jz_inp" id="area" placeholder="请输入名称" />
          </p>

          <p>
            <span>
              <label for="school1">支教学校</label>
            </span>
            <input class="jz_inp" type="text" id="school1" placeholder="请输入名称" />
          </p>
